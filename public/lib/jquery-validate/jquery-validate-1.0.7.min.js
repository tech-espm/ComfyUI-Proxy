...
(function () {
	...
	$.validator.addMethod("cpf", function (value) {
		return (!value || window.validateCPF(value));
	}, "CPF inválido.");

	$.validator.addMethod("cnpj", function (value) {
		return (!value || window.validateCNPJ(value));
	}, "CNPJ inválido.");

	$.validator.addMethod("documento", function (value) {
		return (!value || ((value.length === 14) ? window.validateCPF(value) : window.validateCNPJ(value)));
	}, "Documento inválido.");

	$.validator.addMethod("numeroDecimal", function (value) {
