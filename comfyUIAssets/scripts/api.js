class ComfyApi extends EventTarget {
	...
	constructor() {
		...
		this.extensions_base = window.extensions_base;
		this.ws_base = window.ws_base;
	}
	...
	// @@@ ESPM
	extensionsURL(route) {
		return this.extensions_base + route;
	}
	...
	#createSocket(isReconnect) {
		...
		// @@@ ESPM
		existingSession = (existingSession ? (existingSession + "&idusuario=" + window.usuario.id) : ("?idusuario=" + window.usuario.id));

		this.socket = new WebSocket(
			// @@@ ESPM
			`ws${window.location.protocol === "https:" ? "s" : ""}://${this.ws_base}${existingSession}`
		);
